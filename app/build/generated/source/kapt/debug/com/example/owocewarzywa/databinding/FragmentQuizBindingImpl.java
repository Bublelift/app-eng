...
public class FragmentQuizBindingImpl extends FragmentQuizBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.quizFragment == variableId) {
            setQuizFragment((com.example.owocewarzywa.practice.quiz.QuizFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setQuizFragment(@Nullable com.example.owocewarzywa.practice.quiz.QuizFragment QuizFragment) {
