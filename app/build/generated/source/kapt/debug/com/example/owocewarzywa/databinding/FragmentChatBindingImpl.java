...
public class FragmentChatBindingImpl extends FragmentChatBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recycler_view_messages, 1);
        sViewsWithIds.put(R.id.chat_bar, 2);
        sViewsWithIds.put(R.id.chat_input, 3);
        sViewsWithIds.put(R.id.chat_send, 4);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.chatFragment == variableId) {
            setChatFragment((com.example.owocewarzywa.chat.ChatFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setChatFragment(@Nullable com.example.owocewarzywa.chat.ChatFragment ChatFragment) {
