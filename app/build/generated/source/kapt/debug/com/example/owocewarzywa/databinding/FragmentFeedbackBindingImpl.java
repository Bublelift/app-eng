...
public class FragmentFeedbackBindingImpl extends FragmentFeedbackBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.feedback, 1);
        sViewsWithIds.put(R.id.next_button, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.feedbackFragment == variableId) {
            setFeedbackFragment((com.example.owocewarzywa.FeedbackFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFeedbackFragment(@Nullable com.example.owocewarzywa.FeedbackFragment FeedbackFragment) {
