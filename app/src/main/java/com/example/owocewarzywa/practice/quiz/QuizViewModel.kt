...
class QuizViewModel : ViewModel() {
    ...
    suspend fun initQuiz(level: String, category: String) {
//        Log.e("API: ", DataApi.retrofitService.getQuiz("quiz", level, category).toString())
        try {
            val listResult = DataApi.retrofitService.getQuiz("quiz", level, category)
